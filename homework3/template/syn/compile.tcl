...
# Netlist files
write -format ddc -hierarchy -output netlist/lenet_syn.ddc
write_file -format verilog -hierarchy -output netlist/lenet_syn.v
write_sdf -version 2.1 -significant_digits 4 -context verilog netlist/lenet_syn.sdf
write_sdc netlist/lenet_syn.sdc
write_saif -output netlist/lenet_syn.saif 
